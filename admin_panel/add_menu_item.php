...
<body>
    ...
    <div id="main-container">
        ...
        <section class="product-form-section">
            <h2 class="title warning">New Menu Item Form</h2>
            <form class="product-form" action="controller/menu_item_controller.php" method="post" enctype="multipart/form-data" onsubmit="return validateYouTubeURL()">
                <div>
                    ...
                    <div class="button-flex">
                        ...
                        <input type="submit" value="submit" name="add_item_submit" id="add-product-btn" class="submit-btn success-border">
                    </div>
                </div>
            </form>
        </section>
